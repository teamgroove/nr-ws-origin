...
module.exports = function (RED) {
    ...
    RED.nodes.registerType("websocket-listener-origin", WebSocketListenerNode);
    RED.nodes.registerType("websocket-client-origin", WebSocketListenerNode);
    ...
    RED.nodes.registerType("websocket in origin", WebSocketInNode);
    ...
    RED.nodes.registerType("websocket out origin", WebSocketOutNode);
}
